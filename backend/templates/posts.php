            ...
            <tbody>
                <tr>
                        ...
                        <?php if($row['file_ext'] == 'mp4'){ ?>
                          <td><video width="60" height="60" src="../../includes/forms/img/<?php echo $row['file'];?>" autoplay muted loop></video></td>
                        <?php }else{?>
                        <td><img src="../../includes/forms/img/<?php echo $row['file']; ?>" width="60" height="60" alt=""></td>
                        <?php }?>
                        <?php
