   ...
   <br><br>
    <div class="flex" style="display:flex;justify-content:space-around;">
        <div class="img front" style="width:50%">
           <img src="assets/imgs/kids2.jpg" alt="kids" width="100%">
        </div>
        <div class="p" style="width:50%;">
            <h2>Need Any Help ?<span style="color:blue;"> Contact Us</span> Today!</h2>
            <p>Call us on +2547.....</p>
            <p>Email: kidscomputersystement@gmail.com</p>
            <p>Working Hours 7:30 AM - 5PM(Mon - Mon).</p>
            <!-- gif -->
